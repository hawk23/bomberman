...
//    private Shape[]	playerShapes;
    ...
    public OldBombermanMap(String ref) throws SlickException {
        super(ref);
        init();
    }

    public OldBombermanMap(String ref, boolean loadTileSets) throws SlickException {
        super(ref, loadTileSets);
        init();
    }

    public OldBombermanMap(String ref, String tileSetsLocation) throws SlickException {
        super(ref, tileSetsLocation);
        init();
    }

    public OldBombermanMap(InputStream in) throws SlickException {
        super(in);
        init();
    }

    public OldBombermanMap(InputStream in, String tileSetsLocation) throws SlickException {
